...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Solicitudes de crédito</h6>
            </div>
            <div class=" mx-auto col-md-6 align-self-center">
              <form class="navbar-form" id="formsearchCredits">
                <div class="input-group ">
                  <input type="text" value="" class="form-control bg-light border-0 small" placeholder="Solicitud a buscar">
                  <button type="submit" class="btn btn-primary" onclick="searchCredits(event);return false">
            ...
            <div class="card-body">
              <div class="table-responsive my-custom-scrollbar">
                <table class="table  " data-order='[[ 1, "asc" ]]' data-page-length='25' id="tableCredit" width="100%" cellspacing="0">
                </table>
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="table-responsive">
            <table class="table  " data-order='[[ 1, "asc" ]]' data-page-length='25' id="tableCreditSecurity" width="100%" cellspacing="0">
            </table>
          </div>
        </div>
  ...
  <script src="js/credit_form.js"></script>
  <script>
