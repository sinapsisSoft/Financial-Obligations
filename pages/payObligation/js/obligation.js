...
function getDataClient(table, dataSetCliente, typeSend) {
  try {
    loadPageView();
    var xhttp = new XMLHttpRequest();
    var arrayCell = new Array("Nit Cliente", "Contrato", "Banco", "Tipo de credito", "Tipo de interes", "Metodo de amortizacion","Fecha de desembolso","Valor inicial","# Cuotas","Valor residual","Interes");
    var JsonData;
